...
|-----------------|:-----:|:------:|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Faster function |   —   | FASTFN | If set, your _WP43_ calculates faster without using internal float of extended precision. This is a tradeoff between speed and precision. Affects $\sqrt x$, ln, $\ln \left( 1 + x \right)$, lg, lb, $\log_x y$, $e^x$, $10^x$, $2^x$, $y^x$, $\sqrt[x]{y}$, sin, cos, tan, arcsin, arccos, and arctan. |
