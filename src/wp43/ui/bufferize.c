  ...
  uint16_t convertItemToSubOrSup(uint16_t item, int16_t subOrSup) {
    ...
    if(subOrSup == NC_SUBSCRIPT) {
      switch(item) {
        ...
        case ITM_Y:                 return ITM_SUB_Y;
        case ITM_Z:                 return ITM_SUB_Z;
        case ITM_CH_DIGRAPH:        return ITM_SUB_CH_DIGRAPH;
        case ITM_ch_DIGRAPH:        return ITM_SUB_ch_DIGRAPH;
        case ITM_QU_DIGRAPH:        return ITM_SUB_QU_DIGRAPH;
        case ITM_qu_DIGRAPH:        return ITM_SUB_qu_DIGRAPH;
        default:                    return item;
      }
    }
      ...
      switch(item) {
        ...
        case ITM_Y:                 return ITM_SUP_Y;
        case ITM_Z:                 return ITM_SUP_Z;
        case ITM_CH_DIGRAPH:        return ITM_SUP_CH_DIGRAPH;
        case ITM_ch_DIGRAPH:        return ITM_SUP_ch_DIGRAPH;
        case ITM_QU_DIGRAPH:        return ITM_SUP_QU_DIGRAPH;
        case ITM_qu_DIGRAPH:        return ITM_SUP_qu_DIGRAPH;
        default:                    return item;
      }
    }
