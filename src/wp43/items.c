...
/*  101 */  { fnView,                       tmMDim,                      "VIEW",                                        "VIEW",                                        (0 << TAM_MAX_BITS) |    99, CAT_FNCT | SLS_UNCHANGED | US_UNCHANGED | EIM_DISABLED | PTP_REGISTER     },
...
/* 1501 */  { fnKeyType,                    tmRegister,                  "KTYP?",                                       "KTYP?",                                       (1 << TAM_MAX_BITS) |    85, CAT_FNCT | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_REGISTER     },
