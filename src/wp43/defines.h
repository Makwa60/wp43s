 ...
 */
  ...
  #define X_INTEGER_MODE                           244
  #define X_OVERFLOW_CARRY                         274
  #define X_ALPHA_MODE                             290
  #define X_SSIZE_BEGIN                            309
  #define X_HOURGLASS                              319
  #define X_WATCH                                  335
  ...
  // Number of constants
  #define NUMBER_OF_CONSTANTS_39                   265
